...
class YOLO(object):
    _defaults = {
        "model_path"        : 'quanzhong/Epoch117-Total_Loss1.3790-Val_Loss1.8638.pth',
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            jishu = (count_full, count_empty, count_half)
